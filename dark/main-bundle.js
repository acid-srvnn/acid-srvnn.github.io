...
events.forEach(event => {
    ...
    if (!$("#" + date).length) {
        $("#" + monthAndYear).append(parser_1.Parser.getDateHtml(event));
    }
...
Parser.monthNames = ["January", "February", "March", "April", "May", "June",
